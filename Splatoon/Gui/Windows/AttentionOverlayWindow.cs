...
internal class AttentionOverlayWindow : Window, IDisposable
{
    ...
    public AttentionOverlayWindow() : base($"###SplatoonAttention", SharedFlags | ImGuiWindowFlags.NoBackground, true)
    {
        ...
        // B1(api13): Dalamud.Interface.Windowing.Window has no AllowBackgroundBlur at api13
        // (it is api15-only). Cosmetic: the overlay just does not opt out of background blur.
