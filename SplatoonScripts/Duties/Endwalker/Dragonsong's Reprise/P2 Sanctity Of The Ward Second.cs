...
// TAKE OURS: the walk-back ECommons under TC_forward/Splatoon/ECommons/ ships GameHelpers/Player.cs
// but no GameHelpers/LegacyPlayer sub-namespace, so upstream's plain using does not resolve.
