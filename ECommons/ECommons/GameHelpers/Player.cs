...
public static unsafe class Player
{
    ...
    // porting-note(api13): qualify the type -- an unqualified `Sex` binds to nothing here, and
    // `using Dalamud.Game.Player;` collides with this file's own ECommons.GameHelpers.Player.
