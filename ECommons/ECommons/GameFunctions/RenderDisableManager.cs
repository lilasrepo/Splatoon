...
public unsafe static class RenderDisableManager
{
    ...
    private static void InitializeInternal()
    {
        ...
        // TODO(api13): FFXIVClientStructs 6966 does not map Is3DRenderingDisabled on
        // Graphics.Render.Manager (metadata-verified). Rather than invent an offset, the whole
        // helper degrades to a no-op: RenderDisabled stays null and PlaceRequest does nothing.
        // ICE does not use RenderDisableManager; only ECommonsMain.Dispose touches it.
        PluginLog.Warning("RenderDisableManager is unavailable at api13; render-disable requests will be ignored.");
        RenderDisabled = null;
